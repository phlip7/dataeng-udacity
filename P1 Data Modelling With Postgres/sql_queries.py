...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays ( \
    songplay_id SERIAL, start_time timestamp not null, user_id int not null, level varchar, \
...
artist_table_create = ("CREATE TABLE IF NOT EXISTS artists ( \
    artist_id varchar PRIMARY KEY, name varchar, location varchar, lattitude numeric, longitude numeric)")

time_table_create = ("CREATE TABLE IF NOT EXISTS time ( \
    start_time timestamp PRIMARY KEY, hour time, day int, week int, month int, year int, weekday int)")
