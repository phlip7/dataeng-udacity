...
songplay_table_create = ("CREATE TABLE IF NOT EXISTS songplays ( \
    songplay_id SERIAL PRIMARY KEY, start_time date, user_id int, level varchar, \
...
artist_table_create = ("CREATE TABLE IF NOT EXISTS artists ( \
    artist_id varchar, name varchar, location varchar, lattitude numeric, longitude numeric)")

time_table_create = ("CREATE TABLE IF NOT EXISTS time ( \
    start_time timestamp, hour time, day int, week int, month int, year int, weekday int)")
